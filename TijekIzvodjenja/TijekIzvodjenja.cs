...
namespace Vsite.CSharp
{
    ...
    public class TijekIzvodjenja
    {
        ...
        {
            // TODO: Donje naredbu umetnuti u try-blok te dodati catch blok za hvatanje iznimke u slučaju dijeljenja s 0 i finally blok.
            //Dodati kontrolne ispise gornjih poruka u svaki od tih blokova te provjeriti što će se ispisati.
            try
            {
